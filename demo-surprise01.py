...
def load_data():
    # Load the data
    data_df = pd.read_excel('D:/streamlit/[final] April 2015 to Nov 30 2019 - Transformed Jester Data - .xlsx', header=None)
    # Delete columns[0]
    ...
    # Load the jokes
    jokes_df = pd.read_excel('D:/streamlit/Dataset4JokeSet.xlsx', header=None)
